                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarAlumnos">
                            <li>
                                <a class="dropdown-item" href="index.php?accion=crear">Crear Alumnos</a>
                            </li>
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarReporte" role="button" data-bs-toggle="dropdown" aria-expanded="false">Reporte</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarAlumnos">
                            <li>
                                <a class="dropdown-item" href="index.php?accion=reportar">Generar reporte</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
